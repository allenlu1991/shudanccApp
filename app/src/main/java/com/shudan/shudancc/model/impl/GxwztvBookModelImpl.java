...
package com.shudan.shudancc.model.impl;

import com.shudan.shudancc.ErrorAnalyContentManager;
import com.shudan.shudancc.base.MBaseModelImpl;
...
import com.shudan.shudancc.bean.LibraryKindBookListBean;
import com.shudan.shudancc.bean.LibraryNewBookBean;
import com.shudan.shudancc.bean.SearchBookBean;
import com.shudan.shudancc.bean.WebChapterBean;
import com.shudan.shudancc.cache.ACache;
import com.shudan.shudancc.common.api.IGxwztvApi;
import com.shudan.shudancc.listener.OnGetChapterListListener;
import com.shudan.shudancc.model.IGxwztvBookModel;
        ...
        return Observable.create(new ObservableOnSubscribe<LibraryBean>() {
            ...
            public void subscribe(ObservableEmitter<LibraryBean> e) throws Exception {
                ...
                for (int i = 0; i < newBookEs.size(); i++) {
                    ...
                    LibraryNewBookBean item = new LibraryNewBookBean(itemE.text(), TAG + itemE.attr("href"), TAG, "ztv.la");
                ...
                for (int i = 1; i < hotEs.size(); i++) {
                    ...
                    for (int j = 0; j < bookEs.size(); j++) {
                        ...
                        searchBookBean.setOrigin("ztv.la");
